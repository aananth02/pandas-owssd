...
from model_components.owssd_pandas_model import OWSSDModel
...
def get_args_parser(add_help=True):
    ...
    parser = argparse.ArgumentParser(
        description='VAE Ensemble NCD Training', add_help=add_help)
...
def get_loaders(args):
    ...
    test_loader = make_loader(dataset_test, shuffle=False, batch_size=args.batch_size, num_workers=4)
...
def main(args):
    ...
    if args.prototype_init == 'pandas':
        ...
        model.initialize_model(discovery_loader, novel_loader, base_loader, test_loader)
    else:
    ...
    if args.ncd_ckpt is None:
        ...
        if args.save_name is not None:
            ...
            name = 'owssd_modified_ncd_model.pth'
